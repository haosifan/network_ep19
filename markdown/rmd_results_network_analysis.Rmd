...
Außer der NI haben die Grünen, die GUE/NGL und Renew Europe die höchste Dichte, also den höchsten Anteil an existierenden Verbindungen an allen mööglichen. Könnte bspw. am Alter liegen (tendenziell jüngere Fraktionen), die dann eben social-media-affiner sind. Kommt drauf an, ob es sich lohnt hier hinterher zu forschen (Alter wäre prinzipiell möglich).
