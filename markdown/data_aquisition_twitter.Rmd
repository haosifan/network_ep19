...
Obtain all Edges from MEP connections on twitter. We can even make a directed network of it.
First get all friends of all MEPs. Then filter if the any of the user_ids of the MEP-list is in the "allfriends"-list.
